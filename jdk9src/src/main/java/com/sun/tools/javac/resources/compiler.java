...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.addmods.all.module.path.invalid", "-addmods ALL-MODULE-PATH can only be used when compiling the unnamed module" },
            ...
            { "compiler.err.cant.find.module", "cannot find module: {0}" },
            ...
            { "compiler.err.locn.invalid.arg.for.xpatch", "invalid argument for -Xpatch option: {0}" },
            ...
            { "compiler.err.processorpath.no.processormodulepath", "illegal combination of -processorpath and -processormodulepath" },
            ...
            { "compiler.err.service.definition.is.inner", "the service definition is an inner class: {0}" },
            ...
            { "compiler.err.unexpected.after.module", "unexpected input after module declaration" },
            ...
            { "compiler.err.xaddexports.malformed.entry", "bad value for -XaddExports: {0}" },
            { "compiler.err.xaddexports.too.many", "multiple -XaddExports options for {0}" },
            { "compiler.err.xaddreads.malformed.entry", "bad value for -XaddReads: {0}" },
            { "compiler.err.xaddreads.too.many", "multiple -XaddReads options for {0}" },
            { "compiler.err.xmodule.no.module.sourcepath", "illegal combination of -Xmodule and -modulesourcepath" },
