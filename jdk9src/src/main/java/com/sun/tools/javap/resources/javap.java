...
public final class javap extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.opt.m", "  -m <module-name>         Specify module containing classes to be disassembled" },
            { "main.opt.modulepath", "  -modulepath <path>       Specify where to find application modules" },
            ...
            { "main.opt.upgrademodulepath", "  -upgrademodulepath <path>    Specify where to find upgradeable modules" },
