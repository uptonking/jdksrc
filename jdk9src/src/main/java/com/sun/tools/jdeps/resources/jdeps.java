...
public final class jdeps extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.opt.genmoduleinfo", "  -genmoduleinfo <dir>                 Generate module-info.java under the specified directory.\n                                       The specified JAR files will be analyzed.\n                                       This option cannot be used with -dotoutput or -cp." },
            ...
            { "main.opt.m", "  -m <module-name>                     Specify the name of the module and its transitive\n                                       dependences to be analyzed." },
            { "main.opt.module", "  -module <module-name>                Finds dependences matching the given module name\n                                       (may be given multiple times).\n                                       -package, -regex, -requires are mutual exclusive." },
            { "main.opt.mp", "  -mp <module path>...\n  -modulepath <module path>...         Specify module path" },
            { "main.opt.p", "  -p <pkgname>                         Finds dependences matching the given package name\n  -package <pkgname>                   (may be given multiple times)." },
            { "main.opt.q", "  -q           -quiet                  Do not show missing dependencies from -genmoduleinfo output." },
            ...
            { "main.opt.upgrademodulepath", "  -upgrademodulepath <module path>...  Specify upgrade module path" },
