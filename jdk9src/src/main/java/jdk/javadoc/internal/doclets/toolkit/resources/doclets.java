...
public final class doclets extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.enum_valueof_doc.firstsentence", "Returns the enum constant of this type with the specified name." },
            ...
            { "doclet.enum_values_doc.firstsentence", "Returns an array containing the constants of this enum type, in\nthe order they are declared." },
